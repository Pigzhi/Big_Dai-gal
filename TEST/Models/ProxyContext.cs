...
public partial class ProxyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Chat_Mes__0BBF6EE6C3072DA2");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__4659622977D2ED35");
        ...
        .HasConversion(
            v => v.ToString().ToLower(),        // enum → DB
            v => Enum.Parse<OrderStatus>(v, true) // DB → enum
        )
        .HasMaxLength(20)
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__47027DF5793917BB");
        ...
        {
            entity.HasKey(e => e.Uid).HasName("PK__Users__DD7012647CF0F843");

            entity.HasIndex(e => e.Email, "UQ__Users__AB6E61649AC463D8").IsUnique();
